...
export default async function getListingTransaction(
  nft: string,
  price: number,
  numberOfDay: number,
  ...
  console.log(rentProgram.idl, 'rentProgram.idl');
  ...
  const instruction = rentProgram.instruction.listItem(bnPrice, bnNumOfDay, bnIsListing, {
    accounts: {
